...
class BookshelvesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookshelf" do
    assert_difference("Bookshelf.count") do
      post bookshelves_url, params: { bookshelf: { author: @bookshelf.author, description: @bookshelf.description, title: @bookshelf.title } }
    end
  ...
  test "should update bookshelf" do
    patch bookshelf_url(@bookshelf), params: { bookshelf: { author: @bookshelf.author, description: @bookshelf.description, title: @bookshelf.title } }
