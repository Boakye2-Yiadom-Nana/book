class BookshelvesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @bookshelf.update(bookshelf_params)
        format.html { redirect_to @bookshelf, notice: "Bookshelf was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to bookshelves_path, notice: "Bookshelf was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def bookshelf_params
      params.expect(bookshelf: [ :title, :author, :description ])
    end
end
